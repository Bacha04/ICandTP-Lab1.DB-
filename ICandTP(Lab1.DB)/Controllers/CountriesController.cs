...
namespace ICandTP_Lab1.DB_.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(DbcarsSearchContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Countries != null ? 
                          ...
                          Problem("Entity set 'DbcarsSearchContext.Countries'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbcarsSearchContext.Countries'  is null.");
            }
            var country = await _context.Countries.FindAsync(id);
            if (country != null)
            {
